...
import ShwetaMahajanPic from "../assets/shweta-mahajan.jpeg"
    ...
    return (
        <div className={styles.Interview}>
            ...
            <Container className={styles.Container}>
                ...
                <Row>
                    <h4>Which books have greatly influenced your life and thought process?</h4>
                    <p>
                ...
                <Row>
                    <h4>Is there a “favorite failure” of yours, a failure that has set you up for later success?</h4>
                    <p>
                ...
                <Row>
                    <h4>If you could have a gigantic billboard anywhere with anything written on it, what would be a message you would want to share with millions or billions and why?</h4>
                    <p>
                ...
                <Row>
                    <h4>In the last five years, what new belief, behavior, or habit has improved your life the most?</h4>
                    <p>
                ...
                <Row>
                    <h4>What advice would you give to a college student on how to begin their career? What are the things they should ignore?</h4>
                    <p>
                ...
                <Row>
                    <h4>What challenges do you think a woman in tech faces while moving to more senior roles?</h4>
                    <p>
                ...
                <Row>
                    <h4>What are some of the bad recommendations you hear in your profession?</h4>
                    <p>
                ...
                <Row>
                    <h4>What do you do when you feel unfocused or demotivated?</h4>
                    <p>
                ...
                <Row>
                    <h4>How were you impacted by the lesser proportion of women in tech?</h4>
                    <p>
                ...
                <Row>
                    <h4>Open Comment - Please feel free to drop in anything that you could not fit in the questions above.</h4>
                    <p>
